...
export class Notification {
  ...
  render() {
    ...
    return (h(Host, null,
      ...
      h("div", { part: cn('base', this.animationState, `type-${this.type}`, `variant-${this.variant}`, this.isOpen && 'open'), role: this.role },
        h("div", { part: "icon", "aria-hidden": "true" },
          h("slot", { name: "icon" },
            h(IconTag, { size: ICON_SIZE, selected: this.type === 'toast' }))),
        h("div", { part: "body", "aria-live": this.role === undefined ? undefined : this.innerAriaLive },
  ...
  static get properties() { return {
    ...
    "innerAriaLive": {
      ...
      "docs": {
        "tags": [],
        "text": "(optional) `aria-live` of element"
      },

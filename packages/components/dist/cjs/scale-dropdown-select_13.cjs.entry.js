...
const Switch = class {
  ...
  render() {
    return (index.h(index.Host, null, this.styles && index.h("style", null, this.styles), index.h("div", { class: this.getCssClassMap() }, index.h("label", { id: `${this.inputId}-label`, class: "switch__wrapper" }, index.h("input", { type: "checkbox", name: this.name, class: "switch__control", checked: this.checked, disabled: this.disabled, "aria-labelledby": `${this.inputId}-label`, id: this.inputId, onChange: (event) => {
      ...
      } }), index.h("div", { class: "switch__toggle", "aria-hidden": "true" }, index.h("div", { class: "switch__thumb" }, index.h("scale-icon-action-checkmark", { size: 12, decorative: true, selected: true })), index.h("div", { class: "switch__io-text" }, index.h("span", null, this.checked ? 'I' : '0'))), index.h("div", { class: "switch__toggle--overlay", "aria-hidden": "true" }), this.label && index.h("span", { class: "switch__label-text" }, this.label)))));
  }
  getCssClassMap() {
